...
export default function OnboardingPage() {
  ...
  const onSubmit = async (data: FormData) => {
    // Safety guard — only submit on the final step
            ...
            <div className="flex-1">
              ...
              {step === 0 && (
                ...
                >
                  ...
                  <InfoBox>
                    We only access public data. We never read private repos or commit
              ...
              {step === 1 && (
                ...
                >
                  ...
                  <InfoBox>
                    Skip if you don&apos;t have these — we&apos;ll weight other signals more
                    heavily.
                  </InfoBox>
                </StepWrapper>
              )}
